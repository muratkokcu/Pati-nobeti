# Görsel tasarım kıyaslaması (19 Eylül 2026)

PatiNöbeti'nin arayüzü, sektördeki 28 uygulamayla karşılaştırıldı.

| Dosya | İçerik |
|---|---|
| `00-kendi-arayuzumuz.md` | Kendi ekranlarımızın gözle yapılmış denetimi + kök sebepler |
| `01-evcil-hayvan.md` | 11 evcil hayvan uygulaması + Türkiye taraması |
...
bir şablon. Ürün fikri Türkiye'de rakipsiz, dolayısıyla savunulabilir olan fikir değil **icra**.
