...
export function DemoBanner() {
  return <View accessibilityRole="text" style={styles.banner}><Ionicons color={palette.primary} name="flask-outline" size={layout.icon.md} /><Text style={styles.text}>Yerel demo · hatırlatıcı çalışır; bildirim, ödeme ve hane paylaşımı kapalı</Text></View>;
}
