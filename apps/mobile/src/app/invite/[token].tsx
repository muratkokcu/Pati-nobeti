...
export default function InviteScreen() {
  ...
  const accept = async () => {
    ...
    if (!runtime.gateway || !token) return;
    if (displayName.trim().length < 2) { setFeedback('Kayıtlarda görünecek adınızı gir.'); return; }
