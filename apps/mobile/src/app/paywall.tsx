...
const benefits = ['Planlanan: sınırsız ortak bakım geçmişi', 'Planlanan: birden fazla bakım veren', 'Planlanan: paylaşılabilir bakım özeti'];
